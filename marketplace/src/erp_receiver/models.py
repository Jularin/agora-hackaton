...
class Product(models.Model):
    ...
    types_dict = {"Товар": PRODUCT, "Услуга": SERVICE}
    ...
    barcode = models.IntegerField(null=True, blank=True, verbose_name=l_('Штрихкод'))
...
models_dict = {"category": Category, "measure_unit": MeasureUnit, "product": Product}
